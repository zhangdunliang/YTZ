package com.yxjr.credit.utils.permission;
...
public final class Permission {
     ...
     *
     * @param permissions The permissions.
     * @return the single {@link Permission} instance
     */
    public static Permission permission(@PermissionConstants.Permission final String... permissions) {
        return new Permission(permissions);
    }

    private Permission(final String... permissions) {
     ...
     * @return the single {@link Permission} instance
     */
    public Permission rationale(final OnRationaleListener listener) {
     ...
     * @return the single {@link Permission} instance
     */
    public Permission callback(final SimpleCallback callback) {
     ...
     * @return the single {@link Permission} instance
     */
    public Permission callback(final FullCallback callback) {
     ...
     * @return the single {@link Permission} instance
     */
    public Permission theme(final ThemeCallback callback) {
