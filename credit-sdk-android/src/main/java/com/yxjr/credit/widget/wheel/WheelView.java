package com.yxjr.credit.widget.wheel;
...
public class WheelView extends View {
	...
	private static final int[] SHADOWS_COLORS = new int[] { 0xc8ffffff, 0x96ffffff, 0x33ffffff };
	...
	private void initWheelVal() {
		int startColor = Color.parseColor("#22ffffff");
		int centerColor = Color.parseColor("#00ffffff");
		int endColor = Color.parseColor("#22ffffff");
		int colors[] = { startColor, centerColor, endColor };// 分别为开始颜色，中间夜色，结束颜色
