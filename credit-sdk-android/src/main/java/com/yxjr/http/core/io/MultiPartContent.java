...
import com.yxjr.http.core.ContentTypeFactory;
 ...
 */
public class MultiPartContent extends AbsHttpContent {
	...
	public MultiPartContent(RequestParams params, String encode, IUploadListener listener) {
		super(params, encode);
	...
	private void onProgress(int index, IUploadListener listener, long currentLength, long allLength) {
		if (listener != null)
